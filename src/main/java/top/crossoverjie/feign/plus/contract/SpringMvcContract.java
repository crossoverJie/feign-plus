...
import top.crossoverjie.feign.plus.contract.annotation.*;
...
import static top.crossoverjie.feign.plus.contract.FeignUtils.addTemplateParameter;

/**
 * Function:
 *
 * @author crossoverJie
 * Date: 2022/2/10 00:09
 * @since JDK 11
 */
public class SpringMvcContract extends Contract.BaseContract
    ...
    protected void processAnnotationOnClass(MethodMetadata data, Class<?> clz) {
        // 不需要实现，不然 URL 会重复拼接 @RequestMapping 的路由
    ...
    protected boolean processAnnotationsOnParameter(MethodMetadata data,
        ...
        boolean isCompatibleQueryMap = false;
        ...
        // compatible @SpringQueryMap
        if (isCompatibleQueryMap) {
            AnnotatedParameterProcessor processor = new QueryMapParameterProcessor();
            isHttpAnnotation |= processor.processArgument(context, new SpringQueryMap() {
                @Override
